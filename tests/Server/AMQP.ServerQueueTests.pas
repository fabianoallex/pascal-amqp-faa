...
type
  ...
  [TestFixture]
  TOverflowTests = class
  public
    [Test] procedure DropHead_DescartaAMaisVelha;
    [Test] procedure MaxLengthBytes_ContaOCorpo;
    [Test] procedure MaxLengthBytes_AcumuladorVoltaAoConsumir;
    [Test] procedure RejectPublish_RecusaQuandoCheia;
    [Test] procedure RejectPublish_VoltaAAceitarAoEsvaziar;
    [Test] procedure RejectPublish_VencidaNaoOcupaVaga;
    [Test] procedure TetoGlobalEDaFila_OMenorVence;
