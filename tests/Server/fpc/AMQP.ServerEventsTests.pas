...
type
  ...
  published
    procedure SemAssinante_NaoQuerNenhumTipo;
    procedure Assinatura_FiltraPorTipo;
    procedure EntregaNaOrdemDeEmissao;
    procedure RingCheio_DescartaOMaisNovoEConta;
    procedure HandlerQueLevanta_ContaESegue;
    procedure ReassinarSubstituiAMascara;
    procedure Unsubscribe_ParaDeEntregar;
    procedure TodoTipoTemNome;
  end;

  TServerEventTests = class(TTestCase)
  private
    FBroker: TAMQPServer;
  ...
  protected
    ...
    procedure TearDown; override;
  published
    procedure Conexao_EmiteEstabelecidaEAutenticada;
    procedure Canal_EmiteAberturaEFechamento;
    procedure Publish_EmiteComTamanhoEChave;
    procedure PublishSemRota_MarcaUnroutable;
    procedure ConsumoEAck_Emitem;
...
initialization
  RegisterTest(TEventBusTests);
  RegisterTest(TServerEventTests);
