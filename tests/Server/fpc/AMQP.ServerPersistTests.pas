...
type
  ...
  published
    ...
    procedure Teto_PublishPersistenteAcimaDoTeto_LevaNack;
    procedure Teto_PublishTransiente_PassaMesmoComOLogCheio;
    procedure Teto_PublishRecusado_NaoEntraNaFila;
  end;
